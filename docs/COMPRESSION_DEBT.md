...
| CD-019 | Scenario 2 battle, `chunk_002.txt` | `15,21,23,33,46,49,53,63,66,71,76,79,84,88,90,96,97,103,104,113` | Battle text was shortened to fit inside the original text block and keep the following battle data/portrait assets at byte-identical offsets. Core meaning is preserved, but some tone/detail is flatter: Aizer's threat, bridge instructions, Wheeler/Selena tactical comments, the pixie event, and the Caconsis enemy warning are more concise. | Revisit after the battle chunk suffix format is understood or after a safe pointer-fix relocation is implemented. |
